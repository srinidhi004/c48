...
function setup() {
  ...
  desertbg= createSprite(650, 300, 2500, 1000);
  ...
  igm.visible= false;
  scroll=createSprite(600,200,30,50);
  scroll.addImage(scrollimg);
  scroll.visible=false;
  life1= createSprite(1100,50,30,30);
  life1.addImage(lifeimg);
  life1.scale=0.1;
  life2=createSprite(1150,50,30,30);
  life2.addImage(lifeimg);
  life2.scale=0.1;
  life3=createSprite(1050,50,30,30);
  life3.addImage(lifeimg);
  life3.scale=0.1;
  life4=createSprite(1000,50,30,30);
  life4.addImage(lifeimg);
  life4.scale=0.1;
  life5=createSprite(950,50,30,30);
...
function reset(){
 ...
 function rocks(){
  ...
  function cactus(){
    if(frameCount % 80 === 0){
      plant= createSprite(1300,500,50,200);
